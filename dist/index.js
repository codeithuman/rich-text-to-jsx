...
(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global = global || self),
      factory((global.richTextToJsx = {}), global.React));
})(this, (exports, React) => {
  ...
  let _global = createCommonjsModule$$1((module) => {
  ...
  let _addToUnscopables = function (key) {
  ...
  function textNodeToJsx(node, options, key) {
    ...
    var data = _node$data === void 0 ? {} : _node$data;
    ...
    return marks.reduce((children, mark, markKey) => {
      let element = getElement(mark.type, overrides);
  ...
  function parentNodeToJsx(node, options, key) {
    ...
    var rest = _objectWithoutProperties(data, ['uri']);
  ...
  const RichText = function RichText(_ref) {
    ...
    var options = _objectWithoutProperties(_ref, ['richText']);
